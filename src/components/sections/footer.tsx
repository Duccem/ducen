...
const Footer = () => {
  return (
    <div className="flex bg-white rounded-lg flex-col mt-[120px] py-4 px-[80px] gap-10">
      <p className="text-lg">Contact Us</p>
      <div className="flex w-full items-center">
        <div className="w-1/2 space-y-5">
          <p className="text-7xl inline-block">
      ...
      <div className="w-full flex justify-between   items-center">
        ...
        <div className="flex justify-between items-center gap-4   p-3 rounded-lg">
          <Link
            href={'/services'}
            className="hover:bg-neutral-700 p-3 rounded-md transition-colors duration-300 hover:text-gray-200"
          >
            About us
          </Link>
          <Link
