...
import {
  default as heroImageDark,
  default as heroImageLight,
} from '@/assets/dashboard.png';
import { DynamicImage } from '@/lib/ducen/components/dynamic-image';
...
export function HeroImage() {
  ...
  return (
    <div className="scale-100 mt-10 md:mt-0 lg:absolute -right-[420px] -top-[100px]  2xl:top-[10px] z-10">
      <motion.div
